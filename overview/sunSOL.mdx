...
- **Audited program** → The Solana Stake Pool Program has undergone **multiple third-party audits**, including reviews by [Kudelski Security](https://research.kudelskisecurity.com/) and [Neodyme](https://neodyme.io/), and is battle-tested across millions of SOL staked by other protocols.